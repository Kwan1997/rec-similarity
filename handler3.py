...
nppnsp['nsp'] = CalMetric().Curvecvcalculate(BCFO, fold=5, neighbours=neighbourst1)
end = timeit.default_timer()
time_consumed = end - start
print('#' * 100)
print('This is original BCF model')
print('#' * 100)
for key, val in resultsDict.items():
    print(key, val)
print('Saving dictionary to memory......')
# np.save('./bcf_o.npy', resultsDict)
# np.save('./bcf_o2.npy', nppnsp)
np.save('./bcf_o2_time.npy', time_consumed)
print(time_consumed)
